# RAG From Scratch with Upstage
Inspired by langchain-ai/rag-from-scratch

Please get your UPSTAGE_API_KEY from https://console.upstage.ai/ and put them in .env.
